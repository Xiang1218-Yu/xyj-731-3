 ...
 */
export const COMMON_BUILT_IN_CMAPS = [
    "UniGB-UCS2-H",
    "UniGB-UCS2-V",
    "UniCNS-UCS2-H",
    "UniCNS-UCS2-V",
...
export class AsyncCMapLoader {
    ...
    async load(name, fetcher) {
        ...
        const promise = effectiveFetcher(name).then(data => {
            this.#cache.set(name, data);
     ...
     */
    async #runPreloadRound(names, fetcher) {
     ...
     */
    static #resolvePreloadNames(config) {
